...
proto.pick = function(pickData) {
  ...
  // from stream2tube,
  // - at cell1, we store the 'current' position
  // - at cell1, we store the 'current' velocity norm (aka intensity)
  var pos = this.positions[cell[1]].slice(0, 3)
  var intensity = this.intensity[cell[1]]

  // TODO
  // how to grab u/v/w velocities??,
  // we'll probably need to pass more things to createTubeMesh
